...
nmuonSV_cut = "nmuonSV > 1"
#cut = "MuonSV_pAngle < 0.142 && MuonSV_chi2 < 10 && MuonSV_deltaR < 1.2 && MuonSV_dxySig > 50"
cut = "MuonSV_deltaR < 1.2"
signal_cut = "MuonSV_deltaR < 1.2 && xgb0__m_2p0_ctau_10p0_xiO_1p0_xiL_1p0 > 0.9994"
...
f = TFile("/vols/cms/khl216/muonSV_BDT_background_fixed.root")
...
myFile = TFile("/home/hep/khl216/CMSSW_10_2_13/src/statsForDS/output/muonSV/vector_m_"+mass+"_bdt_new/output_vector_"+mass+"_"+lifetime+"_1_1.root", "RECREATE")
print("TFile created")
...
c2.Print("/home/hep/khl216/CMSSW_10_2_13/src/statsForDS/output/muonSV/vector_m_"+mass+"_bdt_new/muonSV_mass_"+mass+"_"+lifetime+"_1_1.pdf")
