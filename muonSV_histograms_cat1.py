...
parser.add_argument('--mass', dest='mass', action='store', type=int, default=2)
parser.add_argument('--lifetime', dest='lifetime', action='store', type=int, default=10)
...
mass_window_down = mass*0.9
mass_window_up = mass*1.1

nmuonSV_cut = "nmuonSV > 0"
#cut = "MuonSV_pAngle < 0.142 && MuonSV_chi2 < 10 && MuonSV_deltaR < 1.2 && MuonSV_dxySig > 50"
cut = "MuonSV_deltaR < 1.2 && MuonSV_dxy < 1 && MuonSV_pAngle < 0.2"
signal_cut = "MuonSV_deltaR < 1.2 && MuonSV_dxy < 1 && MuonSV_pAngle < 0.2 && xgb0__m_2p0_ctau_10p0_xiO_1p0_xiL_1p0 > 0.9994"
 
mass = str(mass)
lifetime = str(lifetime)

signal_original = TChain()
signal = TChain()
background1 = TChain()
background2 = TChain()
background3 = TChain()
...
background11_bdt_ext = TChain()

signal_bdt.Add("/vols/cms/mmieskol/icenet/output/dqcd/deploy/modeltag__vector_all/vols/cms/mc3909/bparkProductionAll_V1p0/HiddenValley_vector_m_"+mass+"_ctau_"+lifetime+"_xiO_1_xiL_1_privateMC_11X_NANOAODSIM_v1p0_generationSync/*.root/Events")
...
signal.Add("/vols/cms/khl216/nano_out/nanotron_v3_bdt_0_fixed/bparkProductionAll_V1p0/HiddenValley_vector_m_"+mass+"_ctau_"+lifetime+"_xiO_1_xiL_1_privateMC_11X_NANOAODSIM_v1p0_generationSync/*.root/Friends")
background1.Add("/vols/cms/khl216/nano_out/nanotron_v3_bdt_0p95_fixed/bparkProductionAll_V1p0/QCD_Pt-15to20_MuEnrichedPt5_TuneCP5_13TeV_pythia8_RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v3_MINIAODSIM_v1p0_generationSync/*.root/Friends")
background2.Add("/vols/cms/khl216/nano_out/nanotron_v3_bdt_0p95_fixed/bparkProductionAll_V1p0/QCD_Pt-20to30_MuEnrichedPt5_TuneCP5_13TeV_pythia8_RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v4_MINIAODSIM_v1p0_generationSync/*.root/Friends")
background3.Add("/vols/cms/khl216/nano_out/nanotron_v3_bdt_0p95_fixed/bparkProductionAll_V1p0/QCD_Pt-30to50_MuEnrichedPt5_TuneCP5_13TeV_pythia8_RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v3_MINIAODSIM_v1p0_generationSync/*.root/Friends")
background4.Add("/vols/cms/khl216/nano_out/nanotron_v3_bdt_0p95_fixed/bparkProductionAll_V1p0/QCD_Pt-50to80_MuEnrichedPt5_TuneCP5_13TeV_pythia8_RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v3_MINIAODSIM_v1p0_generationSync/*.root/Friends")
background5.Add("/vols/cms/khl216/nano_out/nanotron_v3_bdt_0p95_fixed/bparkProductionAll_V1p0/QCD_Pt-80to120_MuEnrichedPt5_TuneCP5_13TeV_pythia8_RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1_MINIAODSIM_v1p0_generationSync/*.root/Friends")
background6.Add("/vols/cms/khl216/nano_out/nanotron_v3_bdt_0p95_fixed/bparkProductionAll_V1p0/QCD_Pt-120to170_MuEnrichedPt5_TuneCP5_13TeV_pythia8_RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1_MINIAODSIM_v1p0_generationSync/*.root/Friends")

background7.Add("/vols/cms/khl216/nano_out/nanotron_v3_bdt_0p95_fixed/bparkProductionAll_V1p0/QCD_Pt-170to300_MuEnrichedPt5_TuneCP5_13TeV_pythia8_RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v3_MINIAODSIM_v1p0_generationSync/*.root/Friends")
background8.Add("/vols/cms/khl216/nano_out/nanotron_v3_bdt_0p95_fixed/bparkProductionAll_V1p0/QCD_Pt-300to470_MuEnrichedPt5_TuneCP5_13TeV_pythia8_RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v3_MINIAODSIM_v1p0_generationSync/*.root/Friends")
background9.Add("/vols/cms/khl216/nano_out/nanotron_v3_bdt_0p95_fixed/bparkProductionAll_V1p0/QCD_Pt-470to600_MuEnrichedPt5_TuneCP5_13TeV_pythia8_RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1_MINIAODSIM_v1p0_generationSync/*.root/Friends")
background10.Add("/vols/cms/khl216/nano_out/nanotron_v3_bdt_0p95_fixed/bparkProductionAll_V1p0/QCD_Pt-600to800_MuEnrichedPt5_TuneCP5_13TeV_pythia8_RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1_MINIAODSIM_v1p0_generationSync/*.root/Friends")
background11.Add("/vols/cms/khl216/nano_out/nanotron_v3_bdt_0p95_fixed/bparkProductionAll_V1p0/QCD_Pt-800to1000_MuEnrichedPt5_TuneCP5_13TeV_pythia8_RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15_ext3-v2_MINIAODSIM_v1p0_generationSync/*.root/Friends")
background12.Add("/vols/cms/khl216/nano_out/nanotron_v3_bdt_0p95_fixed/bparkProductionAll_V1p0/QCD_Pt-1000toInf_MuEnrichedPt5_TuneCP5_13TeV_pythia8_RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1_MINIAODSIM_v1p0_generationSync/*.root/Friends")

background5_ext.Add("/vols/cms/khl216/nano_out/nanotron_v3_bdt_0p95_fixed/bparkProductionAll_V1p0/QCD_Pt-80to120_MuEnrichedPt5_TuneCP5_13TeV_pythia8_RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15_ext1-v2_MINIAODSIM_v1p0_generationSync/*.root/Friends")
background6_ext.Add("/vols/cms/khl216/nano_out/nanotron_v3_bdt_0p95_fixed/bparkProductionAll_V1p0/QCD_Pt-120to170_MuEnrichedPt5_TuneCP5_13TeV_pythia8_RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15_ext1-v2_MINIAODSIM_v1p0_generationSync/*.root/Friends")
background8_ext.Add("/vols/cms/khl216/nano_out/nanotron_v3_bdt_0p95_fixed/bparkProductionAll_V1p0/QCD_Pt-300to470_MuEnrichedPt5_TuneCP5_13TeV_pythia8_RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15_ext3-v1_MINIAODSIM_v1p0_generationSync/*.root/Friends")
background9_ext.Add("/vols/cms/khl216/nano_out/nanotron_v3_bdt_0p95_fixed/bparkProductionAll_V1p0/QCD_Pt-470to600_MuEnrichedPt5_TuneCP5_13TeV_pythia8_RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15_ext1-v2_MINIAODSIM_v1p0_generationSync/*.root/Friends")
...
#For BDT
no_of_entries_original = df_bdt.Count().GetValue()
...
print("Number of entries in signal =", no_of_entries_original)
...
h_svmass = df.Filter(nmuonSV_cut).Define("muonSV_deltaR", "sqrt((muonSV_mu1phi-muonSV_mu2phi)*(muonSV_mu1phi-muonSV_mu2phi) + (muonSV_mu1eta-muonSV_mu2eta)*(muonSV_mu1eta-muonSV_mu2eta))").Define("MuonSV_deltaR", "muonSV_deltaR[ArgMin(muonSV_chi2)]").Define("MuonSV_dxySig", "muonSV_dxySig[ArgMin(muonSV_chi2)]").Define("MuonSV_pAngle","muonSV_pAngle[ArgMin(muonSV_chi2)]").Define("MuonSV_chi2", "muonSV_chi2[ArgMin(muonSV_chi2)]").Define("MuonSV_dxy", "muonSV_dxy[ArgMin(muonSV_chi2)]").Define("MuonSV_dlen", "muonSV_dlen[ArgMin(muonSV_chi2)]").Define("MuonSV_dlenSig", "muonSV_dlenSig[ArgMin(muonSV_chi2)]").Define("MuonSV_mass", "muonSV_mass[ArgMin(muonSV_chi2)]").Filter(signal_cut).Histo1D(("hist_svmass_nano", "Mass distribution; Mass (GeV); Number of secondary vertices", 50, mass_window_down, mass_window_up), "MuonSV_mass")
h_svmass1 = df1.Filter(nmuonSV_cut).Define("muonSV_deltaR", "sqrt((muonSV_mu1phi-muonSV_mu2phi)*(muonSV_mu1phi-muonSV_mu2phi) + (muonSV_mu1eta-muonSV_mu2eta)*(muonSV_mu1eta-muonSV_mu2eta))").Define("MuonSV_deltaR", "muonSV_deltaR[ArgMin(muonSV_chi2)]").Define("MuonSV_dxySig", "muonSV_dxySig[ArgMin(muonSV_chi2)]").Define("MuonSV_pAngle","muonSV_pAngle[ArgMin(muonSV_chi2)]").Define("MuonSV_chi2", "muonSV_chi2[ArgMin(muonSV_chi2)]").Define("MuonSV_dxy", "muonSV_dxy[ArgMin(muonSV_chi2)]").Define("MuonSV_dlen", "muonSV_dlen[ArgMin(muonSV_chi2)]").Define("MuonSV_dlenSig", "muonSV_dlenSig[ArgMin(muonSV_chi2)]").Define("MuonSV_mass", "muonSV_mass[ArgMin(muonSV_chi2)]").Filter(cut).Histo1D(("hist_svmass1_nano", "Mass distribution; Mass (GeV); Number of secondary vertices", 50, mass_window_down, mass_window_up), "MuonSV_mass")
h_svmass2 = df2.Filter(nmuonSV_cut).Define("muonSV_deltaR", "sqrt((muonSV_mu1phi-muonSV_mu2phi)*(muonSV_mu1phi-muonSV_mu2phi) + (muonSV_mu1eta-muonSV_mu2eta)*(muonSV_mu1eta-muonSV_mu2eta))").Define("MuonSV_deltaR", "muonSV_deltaR[ArgMin(muonSV_chi2)]").Define("MuonSV_dxySig", "muonSV_dxySig[ArgMin(muonSV_chi2)]").Define("MuonSV_pAngle","muonSV_pAngle[ArgMin(muonSV_chi2)]").Define("MuonSV_chi2", "muonSV_chi2[ArgMin(muonSV_chi2)]").Define("MuonSV_dxy", "muonSV_dxy[ArgMin(muonSV_chi2)]").Define("MuonSV_dlen", "muonSV_dlen[ArgMin(muonSV_chi2)]").Define("MuonSV_dlenSig", "muonSV_dlenSig[ArgMin(muonSV_chi2)]").Define("MuonSV_mass", "muonSV_mass[ArgMin(muonSV_chi2)]").Filter(cut).Histo1D(("hist_svmass2_nano", "Mass distribution; Mass (GeV); Number of secondary vertices", 50, mass_window_down, mass_window_up), "MuonSV_mass")
h_svmass3 = df3.Filter(nmuonSV_cut).Define("muonSV_deltaR", "sqrt((muonSV_mu1phi-muonSV_mu2phi)*(muonSV_mu1phi-muonSV_mu2phi) + (muonSV_mu1eta-muonSV_mu2eta)*(muonSV_mu1eta-muonSV_mu2eta))").Define("MuonSV_deltaR", "muonSV_deltaR[ArgMin(muonSV_chi2)]").Define("MuonSV_dxySig", "muonSV_dxySig[ArgMin(muonSV_chi2)]").Define("MuonSV_pAngle","muonSV_pAngle[ArgMin(muonSV_chi2)]").Define("MuonSV_chi2", "muonSV_chi2[ArgMin(muonSV_chi2)]").Define("MuonSV_dxy", "muonSV_dxy[ArgMin(muonSV_chi2)]").Define("MuonSV_dlen", "muonSV_dlen[ArgMin(muonSV_chi2)]").Define("MuonSV_dlenSig", "muonSV_dlenSig[ArgMin(muonSV_chi2)]").Define("MuonSV_mass", "muonSV_mass[ArgMin(muonSV_chi2)]").Filter(cut).Histo1D(("hist_svmass3_nano", "Mass distribution; Mass (GeV); Number of secondary vertices", 50, mass_window_down, mass_window_up), "MuonSV_mass")
h_svmass4 = df4.Filter(nmuonSV_cut).Define("muonSV_deltaR", "sqrt((muonSV_mu1phi-muonSV_mu2phi)*(muonSV_mu1phi-muonSV_mu2phi) + (muonSV_mu1eta-muonSV_mu2eta)*(muonSV_mu1eta-muonSV_mu2eta))").Define("MuonSV_deltaR", "muonSV_deltaR[ArgMin(muonSV_chi2)]").Define("MuonSV_dxySig", "muonSV_dxySig[ArgMin(muonSV_chi2)]").Define("MuonSV_pAngle","muonSV_pAngle[ArgMin(muonSV_chi2)]").Define("MuonSV_chi2", "muonSV_chi2[ArgMin(muonSV_chi2)]").Define("MuonSV_dxy", "muonSV_dxy[ArgMin(muonSV_chi2)]").Define("MuonSV_dlen", "muonSV_dlen[ArgMin(muonSV_chi2)]").Define("MuonSV_dlenSig", "muonSV_dlenSig[ArgMin(muonSV_chi2)]").Define("MuonSV_mass", "muonSV_mass[ArgMin(muonSV_chi2)]").Filter(cut).Histo1D(("hist_svmass4_nano", "Mass distribution; Mass (GeV); Number of secondary vertices", 50, mass_window_down, mass_window_up), "MuonSV_mass")
h_svmass5 = df5.Filter(nmuonSV_cut).Define("muonSV_deltaR", "sqrt((muonSV_mu1phi-muonSV_mu2phi)*(muonSV_mu1phi-muonSV_mu2phi) + (muonSV_mu1eta-muonSV_mu2eta)*(muonSV_mu1eta-muonSV_mu2eta))").Define("MuonSV_deltaR", "muonSV_deltaR[ArgMin(muonSV_chi2)]").Define("MuonSV_dxySig", "muonSV_dxySig[ArgMin(muonSV_chi2)]").Define("MuonSV_pAngle","muonSV_pAngle[ArgMin(muonSV_chi2)]").Define("MuonSV_chi2", "muonSV_chi2[ArgMin(muonSV_chi2)]").Define("MuonSV_dxy", "muonSV_dxy[ArgMin(muonSV_chi2)]").Define("MuonSV_dlen", "muonSV_dlen[ArgMin(muonSV_chi2)]").Define("MuonSV_dlenSig", "muonSV_dlenSig[ArgMin(muonSV_chi2)]").Define("MuonSV_mass", "muonSV_mass[ArgMin(muonSV_chi2)]").Filter(cut).Histo1D(("hist_svmass5_nano", "Mass distribution; Mass (GeV); Number of secondary vertices", 50, mass_window_down, mass_window_up), "MuonSV_mass")
h_svmass6 = df6.Filter(nmuonSV_cut).Define("muonSV_deltaR", "sqrt((muonSV_mu1phi-muonSV_mu2phi)*(muonSV_mu1phi-muonSV_mu2phi) + (muonSV_mu1eta-muonSV_mu2eta)*(muonSV_mu1eta-muonSV_mu2eta))").Define("MuonSV_deltaR", "muonSV_deltaR[ArgMin(muonSV_chi2)]").Define("MuonSV_dxySig", "muonSV_dxySig[ArgMin(muonSV_chi2)]").Define("MuonSV_pAngle","muonSV_pAngle[ArgMin(muonSV_chi2)]").Define("MuonSV_chi2", "muonSV_chi2[ArgMin(muonSV_chi2)]").Define("MuonSV_dxy", "muonSV_dxy[ArgMin(muonSV_chi2)]").Define("MuonSV_dlen", "muonSV_dlen[ArgMin(muonSV_chi2)]").Define("MuonSV_dlenSig", "muonSV_dlenSig[ArgMin(muonSV_chi2)]").Define("MuonSV_mass", "muonSV_mass[ArgMin(muonSV_chi2)]").Filter(cut).Histo1D(("hist_svmass6_nano", "Mass distribution; Mass (GeV); Number of secondary vertices", 50, mass_window_down, mass_window_up), "MuonSV_mass")
h_svmass7 = df7.Filter(nmuonSV_cut).Define("muonSV_deltaR", "sqrt((muonSV_mu1phi-muonSV_mu2phi)*(muonSV_mu1phi-muonSV_mu2phi) + (muonSV_mu1eta-muonSV_mu2eta)*(muonSV_mu1eta-muonSV_mu2eta))").Define("MuonSV_deltaR", "muonSV_deltaR[ArgMin(muonSV_chi2)]").Define("MuonSV_dxySig", "muonSV_dxySig[ArgMin(muonSV_chi2)]").Define("MuonSV_pAngle","muonSV_pAngle[ArgMin(muonSV_chi2)]").Define("MuonSV_chi2", "muonSV_chi2[ArgMin(muonSV_chi2)]").Define("MuonSV_dxy", "muonSV_dxy[ArgMin(muonSV_chi2)]").Define("MuonSV_dlen", "muonSV_dlen[ArgMin(muonSV_chi2)]").Define("MuonSV_dlenSig", "muonSV_dlenSig[ArgMin(muonSV_chi2)]").Define("MuonSV_mass", "muonSV_mass[ArgMin(muonSV_chi2)]").Filter(cut).Histo1D(("hist_svmass7_nano", "Mass distribution; Mass (GeV); Number of secondary vertices", 50, mass_window_down, mass_window_up), "MuonSV_mass")
h_svmass8 = df8.Filter(nmuonSV_cut).Define("muonSV_deltaR", "sqrt((muonSV_mu1phi-muonSV_mu2phi)*(muonSV_mu1phi-muonSV_mu2phi) + (muonSV_mu1eta-muonSV_mu2eta)*(muonSV_mu1eta-muonSV_mu2eta))").Define("MuonSV_deltaR", "muonSV_deltaR[ArgMin(muonSV_chi2)]").Define("MuonSV_dxySig", "muonSV_dxySig[ArgMin(muonSV_chi2)]").Define("MuonSV_pAngle","muonSV_pAngle[ArgMin(muonSV_chi2)]").Define("MuonSV_chi2", "muonSV_chi2[ArgMin(muonSV_chi2)]").Define("MuonSV_dxy", "muonSV_dxy[ArgMin(muonSV_chi2)]").Define("MuonSV_dlen", "muonSV_dlen[ArgMin(muonSV_chi2)]").Define("MuonSV_dlenSig", "muonSV_dlenSig[ArgMin(muonSV_chi2)]").Define("MuonSV_mass", "muonSV_mass[ArgMin(muonSV_chi2)]").Filter(cut).Histo1D(("hist_svmass8_nano", "Mass distribution; Mass (GeV); Number of secondary vertices", 50, mass_window_down, mass_window_up), "MuonSV_mass")
h_svmass9 = df9.Filter(nmuonSV_cut).Define("muonSV_deltaR", "sqrt((muonSV_mu1phi-muonSV_mu2phi)*(muonSV_mu1phi-muonSV_mu2phi) + (muonSV_mu1eta-muonSV_mu2eta)*(muonSV_mu1eta-muonSV_mu2eta))").Define("MuonSV_deltaR", "muonSV_deltaR[ArgMin(muonSV_chi2)]").Define("MuonSV_dxySig", "muonSV_dxySig[ArgMin(muonSV_chi2)]").Define("MuonSV_pAngle","muonSV_pAngle[ArgMin(muonSV_chi2)]").Define("MuonSV_chi2", "muonSV_chi2[ArgMin(muonSV_chi2)]").Define("MuonSV_dxy", "muonSV_dxy[ArgMin(muonSV_chi2)]").Define("MuonSV_dlen", "muonSV_dlen[ArgMin(muonSV_chi2)]").Define("MuonSV_dlenSig", "muonSV_dlenSig[ArgMin(muonSV_chi2)]").Define("MuonSV_mass", "muonSV_mass[ArgMin(muonSV_chi2)]").Filter(cut).Histo1D(("hist_svmass9_nano", "Mass distribution; Mass (GeV); Number of secondary vertices", 50, mass_window_down, mass_window_up), "MuonSV_mass")
h_svmass10 = df10.Filter(nmuonSV_cut).Define("muonSV_deltaR", "sqrt((muonSV_mu1phi-muonSV_mu2phi)*(muonSV_mu1phi-muonSV_mu2phi) + (muonSV_mu1eta-muonSV_mu2eta)*(muonSV_mu1eta-muonSV_mu2eta))").Define("MuonSV_deltaR", "muonSV_deltaR[ArgMin(muonSV_chi2)]").Define("MuonSV_dxySig", "muonSV_dxySig[ArgMin(muonSV_chi2)]").Define("MuonSV_pAngle","muonSV_pAngle[ArgMin(muonSV_chi2)]").Define("MuonSV_chi2", "muonSV_chi2[ArgMin(muonSV_chi2)]").Define("MuonSV_dxy", "muonSV_dxy[ArgMin(muonSV_chi2)]").Define("MuonSV_dlen", "muonSV_dlen[ArgMin(muonSV_chi2)]").Define("MuonSV_dlenSig", "muonSV_dlenSig[ArgMin(muonSV_chi2)]").Define("MuonSV_mass", "muonSV_mass[ArgMin(muonSV_chi2)]").Filter(cut).Histo1D(("hist_svmass10_nano", "Mass distribution; Mass (GeV); Number of secondary vertices", 50, mass_window_down, mass_window_up), "MuonSV_mass")
h_svmass11 = df11.Filter(nmuonSV_cut).Define("muonSV_deltaR", "sqrt((muonSV_mu1phi-muonSV_mu2phi)*(muonSV_mu1phi-muonSV_mu2phi) + (muonSV_mu1eta-muonSV_mu2eta)*(muonSV_mu1eta-muonSV_mu2eta))").Define("MuonSV_deltaR", "muonSV_deltaR[ArgMin(muonSV_chi2)]").Define("MuonSV_dxySig", "muonSV_dxySig[ArgMin(muonSV_chi2)]").Define("MuonSV_pAngle","muonSV_pAngle[ArgMin(muonSV_chi2)]").Define("MuonSV_chi2", "muonSV_chi2[ArgMin(muonSV_chi2)]").Define("MuonSV_dxy", "muonSV_dxy[ArgMin(muonSV_chi2)]").Define("MuonSV_dlen", "muonSV_dlen[ArgMin(muonSV_chi2)]").Define("MuonSV_dlenSig", "muonSV_dlenSig[ArgMin(muonSV_chi2)]").Define("MuonSV_mass", "muonSV_mass[ArgMin(muonSV_chi2)]").Filter(cut).Histo1D(("hist_svmass11_nano", "Mass distribution; Mass (GeV); Number of secondary vertices", 50, mass_window_down, mass_window_up), "MuonSV_mass")
h_svmass12 = df12.Filter(nmuonSV_cut).Define("muonSV_deltaR", "sqrt((muonSV_mu1phi-muonSV_mu2phi)*(muonSV_mu1phi-muonSV_mu2phi) + (muonSV_mu1eta-muonSV_mu2eta)*(muonSV_mu1eta-muonSV_mu2eta))").Define("MuonSV_deltaR", "muonSV_deltaR[ArgMin(muonSV_chi2)]").Define("MuonSV_dxySig", "muonSV_dxySig[ArgMin(muonSV_chi2)]").Define("MuonSV_pAngle","muonSV_pAngle[ArgMin(muonSV_chi2)]").Define("MuonSV_chi2", "muonSV_chi2[ArgMin(muonSV_chi2)]").Define("MuonSV_dxy", "muonSV_dxy[ArgMin(muonSV_chi2)]").Define("MuonSV_dlen", "muonSV_dlen[ArgMin(muonSV_chi2)]").Define("MuonSV_dlenSig", "muonSV_dlenSig[ArgMin(muonSV_chi2)]").Define("MuonSV_mass", "muonSV_mass[ArgMin(muonSV_chi2)]").Filter(cut).Histo1D(("hist_svmass12_nano", "Mass distribution; Mass (GeV); Number of secondary vertices", 50, mass_window_down, mass_window_up), "MuonSV_mass")
'''
h_svmass = df.Filter("nmuonSV > 1").Define("muonSV_deltaR", "sqrt(pow(muonSV_mu1phi-muonSV_mu2phi, 2) + pow(muonSV_mu1eta-muonSV_mu2eta, 2))").Define("MuonSV_deltaR", "muonSV_deltaR[ArgMin(muonSV_chi2)]").Define("MuonSV_dxySig", "muonSV_dxySig[ArgMin(muonSV_chi2)]").Define("MuonSV_pAngle","muonSV_pAngle[ArgMin(muonSV_chi2)]").Define("MuonSV_chi2", "muonSV_chi2[ArgMin(muonSV_chi2)]").Define("MuonSV_mass", "muonSV_mass[ArgMin(muonSV_chi2)]").Histo1D(("hist_svmass_nano", "Mass distribution; Mass (GeV); Number of secondary vertices", 50, 1.8, 2.2), "MuonSV_mass")
h_svmass1 = df1.Filter("nmuonSV > 1").Define("muonSV_deltaR", "sqrt(pow(muonSV_mu1phi-muonSV_mu2phi, 2) + pow(muonSV_mu1eta-muonSV_mu2eta, 2))").Define("MuonSV_deltaR", "muonSV_deltaR[ArgMin(muonSV_chi2)]").Define("MuonSV_dxySig", "muonSV_dxySig[ArgMin(muonSV_chi2)]").Define("MuonSV_pAngle","muonSV_pAngle[ArgMin(muonSV_chi2)]").Define("MuonSV_chi2", "muonSV_chi2[ArgMin(muonSV_chi2)]").Define("MuonSV_mass", "muonSV_mass[ArgMin(muonSV_chi2)]").Histo1D(("hist_svmass_nano", "Mass distribution; Mass (GeV); Number of secondary vertices", 50, 1.8, 2.2), "MuonSV_mass")
h_svmass2 = df2.Filter("nmuonSV > 1").Define("muonSV_deltaR", "sqrt(pow(muonSV_mu1phi-muonSV_mu2phi, 2) + pow(muonSV_mu1eta-muonSV_mu2eta, 2))").Define("MuonSV_deltaR", "muonSV_deltaR[ArgMin(muonSV_chi2)]").Define("MuonSV_dxySig", "muonSV_dxySig[ArgMin(muonSV_chi2)]").Define("MuonSV_pAngle","muonSV_pAngle[ArgMin(muonSV_chi2)]").Define("MuonSV_chi2", "muonSV_chi2[ArgMin(muonSV_chi2)]").Define("MuonSV_mass", "muonSV_mass[ArgMin(muonSV_chi2)]").Histo1D(("hist_svmass_nano", "Mass distribution; Mass (GeV); Number of secondary vertices", 50, 1.8, 2.2), "MuonSV_mass")
h_svmass3 = df3.Filter("nmuonSV > 1").Define("muonSV_deltaR", "sqrt(pow(muonSV_mu1phi-muonSV_mu2phi, 2) + pow(muonSV_mu1eta-muonSV_mu2eta, 2))").Define("MuonSV_deltaR", "muonSV_deltaR[ArgMin(muonSV_chi2)]").Define("MuonSV_dxySig", "muonSV_dxySig[ArgMin(muonSV_chi2)]").Define("MuonSV_pAngle","muonSV_pAngle[ArgMin(muonSV_chi2)]").Define("MuonSV_chi2", "muonSV_chi2[ArgMin(muonSV_chi2)]").Define("MuonSV_mass", "muonSV_mass[ArgMin(muonSV_chi2)]").Histo1D(("hist_svmass_nano", "Mass distribution; Mass (GeV); Number of secondary vertices", 50, 1.8, 2.2), "MuonSV_mass")
h_svmass4 = df4.Filter("nmuonSV > 1").Define("muonSV_deltaR", "sqrt(pow(muonSV_mu1phi-muonSV_mu2phi, 2) + pow(muonSV_mu1eta-muonSV_mu2eta, 2))").Define("MuonSV_deltaR", "muonSV_deltaR[ArgMin(muonSV_chi2)]").Define("MuonSV_dxySig", "muonSV_dxySig[ArgMin(muonSV_chi2)]").Define("MuonSV_pAngle","muonSV_pAngle[ArgMin(muonSV_chi2)]").Define("MuonSV_chi2", "muonSV_chi2[ArgMin(muonSV_chi2)]").Define("MuonSV_mass", "muonSV_mass[ArgMin(muonSV_chi2)]").Histo1D(("hist_svmass_nano", "Mass distribution; Mass (GeV); Number of secondary vertices", 50, 1.8, 2.2), "MuonSV_mass")
h_svmass5 = df5.Filter("nmuonSV > 1").Define("muonSV_deltaR", "sqrt(pow(muonSV_mu1phi-muonSV_mu2phi, 2) + pow(muonSV_mu1eta-muonSV_mu2eta, 2))").Define("MuonSV_deltaR", "muonSV_deltaR[ArgMin(muonSV_chi2)]").Define("MuonSV_dxySig", "muonSV_dxySig[ArgMin(muonSV_chi2)]").Define("MuonSV_pAngle","muonSV_pAngle[ArgMin(muonSV_chi2)]").Define("MuonSV_chi2", "muonSV_chi2[ArgMin(muonSV_chi2)]").Define("MuonSV_mass", "muonSV_mass[ArgMin(muonSV_chi2)]").Histo1D(("hist_svmass_nano", "Mass distribution; Mass (GeV); Number of secondary vertices", 50, 1.8, 2.2), "MuonSV_mass")
h_svmass6 = df6.Filter("nmuonSV > 1").Define("muonSV_deltaR", "sqrt(pow(muonSV_mu1phi-muonSV_mu2phi, 2) + pow(muonSV_mu1eta-muonSV_mu2eta, 2))").Define("MuonSV_deltaR", "muonSV_deltaR[ArgMin(muonSV_chi2)]").Define("MuonSV_dxySig", "muonSV_dxySig[ArgMin(muonSV_chi2)]").Define("MuonSV_pAngle","muonSV_pAngle[ArgMin(muonSV_chi2)]").Define("MuonSV_chi2", "muonSV_chi2[ArgMin(muonSV_chi2)]").Define("MuonSV_mass", "muonSV_mass[ArgMin(muonSV_chi2)]").Histo1D(("hist_svmass_nano", "Mass distribution; Mass (GeV); Number of secondary vertices", 50, 1.8, 2.2), "MuonSV_mass")
h_svmass7 = df7.Filter("nmuonSV > 1").Define("muonSV_deltaR", "sqrt(pow(muonSV_mu1phi-muonSV_mu2phi, 2) + pow(muonSV_mu1eta-muonSV_mu2eta, 2))").Define("MuonSV_deltaR", "muonSV_deltaR[ArgMin(muonSV_chi2)]").Define("MuonSV_dxySig", "muonSV_dxySig[ArgMin(muonSV_chi2)]").Define("MuonSV_pAngle","muonSV_pAngle[ArgMin(muonSV_chi2)]").Define("MuonSV_chi2", "muonSV_chi2[ArgMin(muonSV_chi2)]").Define("MuonSV_mass", "muonSV_mass[ArgMin(muonSV_chi2)]").Histo1D(("hist_svmass_nano", "Mass distribution; Mass (GeV); Number of secondary vertices", 50, 1.8, 2.2), "MuonSV_mass")
h_svmass8 = df8.Filter("nmuonSV > 1").Define("muonSV_deltaR", "sqrt(pow(muonSV_mu1phi-muonSV_mu2phi, 2) + pow(muonSV_mu1eta-muonSV_mu2eta, 2))").Define("MuonSV_deltaR", "muonSV_deltaR[ArgMin(muonSV_chi2)]").Define("MuonSV_dxySig", "muonSV_dxySig[ArgMin(muonSV_chi2)]").Define("MuonSV_pAngle","muonSV_pAngle[ArgMin(muonSV_chi2)]").Define("MuonSV_chi2", "muonSV_chi2[ArgMin(muonSV_chi2)]").Define("MuonSV_mass", "muonSV_mass[ArgMin(muonSV_chi2)]").Histo1D(("hist_svmass_nano", "Mass distribution; Mass (GeV); Number of secondary vertices", 50, 1.8, 2.2), "MuonSV_mass")
h_svmass9 = df9.Filter("nmuonSV > 1").Define("muonSV_deltaR", "sqrt(pow(muonSV_mu1phi-muonSV_mu2phi, 2) + pow(muonSV_mu1eta-muonSV_mu2eta, 2))").Define("MuonSV_deltaR", "muonSV_deltaR[ArgMin(muonSV_chi2)]").Define("MuonSV_dxySig", "muonSV_dxySig[ArgMin(muonSV_chi2)]").Define("MuonSV_pAngle","muonSV_pAngle[ArgMin(muonSV_chi2)]").Define("MuonSV_chi2", "muonSV_chi2[ArgMin(muonSV_chi2)]").Define("MuonSV_mass", "muonSV_mass[ArgMin(muonSV_chi2)]").Histo1D(("hist_svmass_nano", "Mass distribution; Mass (GeV); Number of secondary vertices", 50, 1.8, 2.2), "MuonSV_mass")
h_svmass10 = df10.Filter("nmuonSV > 1").Define("muonSV_deltaR", "sqrt(pow(muonSV_mu1phi-muonSV_mu2phi, 2) + pow(muonSV_mu1eta-muonSV_mu2eta, 2))").Define("MuonSV_deltaR", "muonSV_deltaR[ArgMin(muonSV_chi2)]").Define("MuonSV_dxySig", "muonSV_dxySig[ArgMin(muonSV_chi2)]").Define("MuonSV_pAngle","muonSV_pAngle[ArgMin(muonSV_chi2)]").Define("MuonSV_chi2", "muonSV_chi2[ArgMin(muonSV_chi2)]").Define("MuonSV_mass", "muonSV_mass[ArgMin(muonSV_chi2)]").Histo1D(("hist_svmass_nano", "Mass distribution; Mass (GeV); Number of secondary vertices", 50, 1.8, 2.2), "MuonSV_mass")
h_svmass11 = df11.Filter("nmuonSV > 1").Define("muonSV_deltaR", "sqrt(pow(muonSV_mu1phi-muonSV_mu2phi, 2) + pow(muonSV_mu1eta-muonSV_mu2eta, 2))").Define("MuonSV_deltaR", "muonSV_deltaR[ArgMin(muonSV_chi2)]").Define("MuonSV_dxySig", "muonSV_dxySig[ArgMin(muonSV_chi2)]").Define("MuonSV_pAngle","muonSV_pAngle[ArgMin(muonSV_chi2)]").Define("MuonSV_chi2", "muonSV_chi2[ArgMin(muonSV_chi2)]").Define("MuonSV_mass", "muonSV_mass[ArgMin(muonSV_chi2)]").Histo1D(("hist_svmass_nano", "Mass distribution; Mass (GeV); Number of secondary vertices", 50, 1.8, 2.2), "MuonSV_mass")
h_svmass12 = df12.Filter("nmuonSV > 1").Define("muonSV_deltaR", "sqrt(pow(muonSV_mu1phi-muonSV_mu2phi, 2) + pow(muonSV_mu1eta-muonSV_mu2eta, 2))").Define("MuonSV_deltaR", "muonSV_deltaR[ArgMin(muonSV_chi2)]").Define("MuonSV_dxySig", "muonSV_dxySig[ArgMin(muonSV_chi2)]").Define("MuonSV_pAngle","muonSV_pAngle[ArgMin(muonSV_chi2)]").Define("MuonSV_chi2", "muonSV_chi2[ArgMin(muonSV_chi2)]").Define("MuonSV_mass", "muonSV_mass[ArgMin(muonSV_chi2)]").Histo1D(("hist_svmass_nano", "Mass distribution; Mass (GeV); Number of secondary vertices", 50, 1.8, 2.2), "MuonSV_mass")
'''
print("TH1D done")
...
f = TFile("/vols/cms/khl216/muonSV_BDT_background_fixed_nmuonSV0.root")
bdt_0p95 = f.Get("BDT > 0.95")
bdt_0p9994 = f.Get("BDT > 0.9994")

h_svmass1.Scale(bdt_0p9994.Integral()/bdt_0p95.Integral())


myFile = TFile("/home/hep/khl216/CMSSW_10_2_13/src/statsForDS/output/muonSV/categories/cat1/vector_m_"+mass+"/output_vector_"+mass+"_"+lifetime+"_1_1.root", "RECREATE")
print("TFile created")

myFile.WriteObject(h_svmass1.GetPtr(), "background")
myFile.WriteObject(h_svmass.GetPtr(), "signal")
myFile.WriteObject(h_svmass1.GetPtr(), "data_obs")
...
out_legend2.AddEntry(h_svmass1.GetPtr(), "Background", "l")
out_legend2.AddEntry(h_svmass.GetPtr(), "Signal", "l")
out_legend2.Draw("Same")

c2.Print("/home/hep/khl216/CMSSW_10_2_13/src/statsForDS/output/muonSV/categories/cat1/vector_m_"+mass+"/muonSV_mass_"+mass+"_"+lifetime+"_1_1.pdf")
